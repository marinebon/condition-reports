...
#Set species names as row.names and remove extra columns
  ...
  saveRDS(func.dist.23, "functional_diversity/func_dist_23_rds")
...
```{r psu biomass}
psu_bio = read_rds("https://github.com/mhepner90/RVC/blob/master/psu_bio_sum_rds?raw=true")
```

```{r psu biodiversity}
psu_div = read_rds("https://github.com/mhepner90/RVC/blob/master/psu_div_rds?raw=true")
```

```{r biodiversity 2.0}
fd_evenness = read_rds("https://github.com/mhepner90/RVC/blob/master/fd_eveness_rds?raw=true")
```
...
all_matrices_data = read_rds("https://github.com/mhepner90/RVC/blob/master/psu_matrices_data_rds?raw=true")

stats_all_matrices_data = read_rds("https://github.com/mhepner90/RVC/blob/master/stats_all_matrices_data_rds?raw=true")
...
Plot by year with rich, simp, shan, and func on one graph
```{r diveristy on one plot}
...
#Rename levels for figure plotting
  ...
  diveristy_year_plot = diversity_plot %>%
    ...
    labs(title= "Florida Keys Reef Fish Biodiversity", x="Year", y="", colour = "Diversity index")+
  ...
  theme(
      ...
      panel.grid.major=element_line(color="grey55"), #element_blank()
      panel.grid.minor=element_blank(),
      panel.background=element_rect(fill="grey45"),
      axis.title.x=element_text(size=12),
      axis.title.y=element_text(size=12),
...
simp_shan_func_plot =  
    ...
    geom_point(size=3)+
    geom_line(aes(group=variable),lwd=1)+
    labs(title= "Florida Keys Reef Fish Biodiversity", x="Year", y="Effective Number of Species", colour = "Diversity index")+
  ...
  scale_color_manual(
    labels= c("Shannon Diversity","Simpson diversity","Functional diversity"),
    values=c("Shannon"="forestgreen",
             "Simpson"="green",
             "Functional"="blue"))+
  #theme_bw()+
  theme(
...
matrices_strat_grouped = read_rds("https://github.com/mhepner90/RVC/blob/master/matrices_strat_grouped_rds?raw=true")
...
matrices_strat_grouped_with_subregion = read_rds("https://github.com/mhepner90/RVC/blob/master/matrices_strat_grouped_with_subregion_rds?raw=true") # 184 x 45
...
all_matrices_data_with_subregion = read_rds("https://github.com/mhepner90/RVC/blob/master/psu_matrices_data_with_subregion_rds?raw=true")
...
matrices_strat_and_year_grouped = read_rds("https://github.com/mhepner90/RVC/blob/master/matrices_strat_and_year_grouped_with_subregion_rds?raw=true")
...
# by STRAT_GROUPED and YEAR
#mean abundance
st_g = ggplot(matrices_strat_grouped,aes(x=YEAR,y=abundance_mean, colour=STRAT_GROUPED, group=STRAT_GROUPED))+ #shape=STRAT
  geom_line(aes(group=STRAT_GROUPED),lwd=1) +
  geom_point(size=3) +
  geom_errorbar(aes(ymax=abundance_mean+abundance_se,ymin=abundance_mean-abundance_se),width=0.1)+
...
#mean biomass
bm_st = ggplot(matrices_strat_grouped,aes(x=YEAR,y=biomass_mean, colour=STRAT_GROUPED, group=STRAT_GROUPED))+ #shape=STRAT
  geom_line(aes(group=STRAT_GROUPED),lwd=1) +
  geom_point(size=3) +
  geom_errorbar(aes(ymin=biomass_mean-biomass_se, ymax=biomass_mean+biomass_se), width=.2)+
...
#mean richness
mn_rch = ggplot(matrices_strat_grouped,aes(x=YEAR,y=richness_mean, colour=STRAT_GROUPED, group=STRAT_GROUPED))+ #shape=STRAT
  geom_line(aes(group=STRAT_GROUPED),lwd=1) +
  geom_point(size=3) +
  geom_errorbar(aes(ymin=richness_mean-richness_se, ymax=richness_mean+richness_se), width=.2)+
...
#mean simpson
mean_sim = ggplot(matrices_strat_grouped,aes(x=YEAR,y=simpson_mean, colour=STRAT_GROUPED, group=STRAT_GROUPED))+ #shape=STRAT
  geom_line(aes(group=STRAT_GROUPED),lwd=1) +
  geom_point(size=3) +
  geom_errorbar(aes(ymin=simpson_mean-simpson_se, ymax=simpson_mean+simpson_se), width=.2)+
...
# by STRAT
#abundance
st_ab = ggplot(matrices_strat_grouped, aes(x=STRAT_GROUPED, y=abundance_mean)) +
  geom_bar(position=position_dodge(), stat="identity") +
  geom_errorbar(aes(ymin=abundance_mean-abundance_se, ymax=abundance_mean+abundance_se), width=.2, position=position_dodge(.9)) +
  theme_classic() +
  theme(axis.text.x = element_text(angle=90)) +
...
matrices_ntmr = read_rds("https://github.com/mhepner90/RVC/blob/master/matrices_strat_grouped_rds?raw=true")
...
```{r percent strat in NTMR}

#matrices_ntmr = read_rds("https://github.com/mhepner90/RVC/blob/master/matrices_ntmr_rds?raw=true")

all_matrices_data = read_rds("https://github.com/mhepner90/RVC/blob/master/psu_matrices_data_rds?raw=true")

percent_ntmr = all_matrices_data %>% #5238
  filter(PROT != 0) %>% #1393
  filter(STRAT == "HRRF") #430
#HRRF (430/1393)*100 #30.86%

percent_ntmr = all_matrices_data %>% #5238
  filter(PROT != 0) %>% #1393
  filter(STRAT == "INPR") #53
#INPR (53/1393)*100 = 3.8%

percent_ntmr = all_matrices_data %>% #5238
  filter(PROT != 0) %>% #1393
  filter(STRAT == "MCPR") %>% #100
#MCPR (100/1393)*100  7.17%

percent_ntmr = all_matrices_data %>% #5238
  filter(PROT != 0) %>% #1393
  filter(STRAT == "OFPR")  #97
#OFPR (97/1393)*100 6.96%

percent_ntmr = all_matrices_data %>% #5238
  filter(PROT != 0) %>% #1393
  filter(STRAT == "FSLR")  #253
# FSLR (253/1393)*100 18.16%

percent_ntmr = all_matrices_data %>% #5238
  filter(PROT != 0) %>% #1393
  filter(STRAT == "FMLR")  #460
# FMLR (460/1393)*100 33.02%
...
#Average the deviances for all models in which a predictor appeared and calculate a standard error. The partial deviances are therefore the proportion of total explained deviance of the model uniquely explained by space, time, environment or management.
  ...
  richness_prop.deviance = read_rds("https://github.com/mhepner90/RVC/blob/master/richness_prop.deviance_rds?raw=true")
  richness_model_summary = read_rds("https://github.com/mhepner90/RVC/blob/master/richness_model_summary_rds?raw=true")
}
...
if(!file.exists("abun_prop.deviance_rds","abun_model_summary_rds")){
  ...
  abun_prop.deviance = read_rds("https://github.com/mhepner90/RVC/blob/master/abun_prop.deviance_rds?raw=true")
  abun_model_summary = read_rds("https://github.com/mhepner90/RVC/blob/master/abun_model_summary_rds?raw=true")
}
...
if(!file.exists("bio_prop.deviance_rds", "bio_model_summary_rds")){
  ...
  bio_prop.deviance = read_rds("https://github.com/mhepner90/RVC/blob/master/bio_prop.deviance_rds?raw=true")
  bio_model_summary = read_rds("https://github.com/mhepner90/RVC/blob/master/bio_model_summary_rds?raw=true")
}
...
#Average the deviances for all models in which a predictor appeared and calculate a standard error. The partial deviances are therefore the proportion of total explained deviance of the model uniquely explained by space, time, environment or management.
  ...
  saveRDS(even_model_summary, "even_model_summary_rds")
    ...
    even_partial_deviance = read_rds("https://github.com/mhepner90/RVC/blob/master/even_prop.deviance_rds?raw=true")
    even_model_summary = ead_rds("https://github.com/mhepner90/RVC/blob/master/even_model_summary_rds?raw=true")
}
...
if(!file.exists("simp_prop.deviance_rds","simp_model_summary_rds")){
  ...
  simp_prop.deviance = read_rds("https://github.com/mhepner90/RVC/blob/master/simp_prop.deviance_rds?raw=true")
  simp_model_summary = read_rds("https://github.com/mhepner90/RVC/blob/master/simp_model_summary_rds?raw=true")
}
...
#Average the deviances for all models in which a predictor appeared and calculate a standard error. The partial deviances are therefore the proportion of total explained deviance of the model uniquely explained by space, time, environment or management.
  ...
  shan_prop.deviance = read_rds("https://github.com/mhepner90/RVC/blob/master/shan_prop.deviance_rds?raw=true")
  shan_model_summary = read_rds("https://github.com/mhepner90/RVC/blob/master/shan_model_summary_rds?raw=true")   
}
...
#Average the deviances for all models in which a predictor appeared and calculate a standard error. The partial deviances are therefore the proportion of total explained deviance of the model uniquely explained by space, time, environment or management.
  ...
  func_prop.deviance = read_rds("https://github.com/mhepner90/RVC/blob/master/func_prop.deviance_rds?raw=true")
  func_model_summary = read_rds("https://github.com/mhepner90/RVC/blob/master/func_model_summary_rds?raw=true")
}
...
partial_deviance_list = read_csv("https://raw.githubusercontent.com/mhepner90/RVC/master/partial_deviance_list.csv")
...
print(partial_deviance_explained)
```
